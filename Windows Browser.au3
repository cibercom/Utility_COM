...
#include <GuiEdit.au3>
$Form1 = GUICreate("Explorador Subcarpetas - Autoit", 380, 388, -1, -1)
...
$Label1 = GUICtrlCreateLabel("http://autoit.com/", 88, 360, 202, 17)
...
Func LogFile($FileName)
	FileWriteLine(@ScriptDir & "\Archivos-Autoit.txt",$FileName)
	$FileCount += 1
	_GUICtrlEdit_AppendText($Edit1, $FileName & "" & @CRLF)
	Sleep(50)
	FileWriteLine(@ScriptDir & "\Archivos-Autoit.txt","---------------------------------------------------------------------------------")
EndFunc
